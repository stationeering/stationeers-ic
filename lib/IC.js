...
module.exports = function () {
  ...
  _createClass(IC, [{
    ...
    key: "getSleepPeriod",
    value: function getSleepPeriod() {
      return this._sleepPeriod;
    }
  }, {
    key: "getAliases",
    value: function getAliases() {
      return Object.keys(this._aliases).filter(function (n) {
        return !["db", "sp", "ra"].includes(n);
      });
    }
  }, {
    key: "getDefines",
    ...
    key: "getJumpTags",
    value: function getJumpTags() {
      return this._jumpTags;
    }
  }, {
    key: "getTokenisedInstructions",
    value: function getTokenisedInstructions() {
      var _this4 = this;

      return this._instructions.map(function (i) {
        return _this4._parseLine(i);
      });
    }
  }, {
    key: "getIOLabels",
    ...
    value: function getInstructions() {
      ...
      return Object.keys(this._opcodes).reduce(function (acc, opcode) {
        acc[opcode] = { category: _this5._opcodes[opcode].category, fields: _this5._opcodes[opcode].fields };
        return acc;
      }, {});
    }
  }, {
