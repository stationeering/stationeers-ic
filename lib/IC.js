...
module.exports = function () {
  ...
  _createClass(IC, [{
    ...
    key: "setIOSlots",
    value: function setIOSlots(index, slot, logicType, value) {
      if (index <= IO_REGISTER_COUNT) {
        if (value !== undefined) {
    ...
    key: "setIOReagents",
    value: function setIOReagents(index, reagent, logicReagentMode, value) {
      if (index <= IO_REGISTER_COUNT) {
        if (value !== undefined) {
    ...
    key: "_instruction_ls",
    value: function _instruction_ls(fields, allowedTypes) {
    ...
    key: "_instruction_lr",
    value: function _instruction_lr(fields, allowedTypes) {
      var deviceNumber = this._resolveDeviceNumber(fields[1], allowedTypes[1]);
      var value = 0;
